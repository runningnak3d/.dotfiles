...
hi Cursor          guifg=#000d18 guibg=#8faf9f gui=bold       ctermfg=233 ctermbg=NONE cterm=bold
...
hi DiffAdd         guifg=#709080 guibg=#313c36 gui=bold       ctermfg=66  ctermbg=NONE cterm=bold
hi DiffChange      guibg=#333333                              ctermbg=NONE
hi DiffDelete      guifg=#333333 guibg=#464646                ctermfg=236 ctermbg=NONE
hi DiffText        guifg=#ecbcbc guibg=#41363c gui=bold       ctermfg=217 ctermbg=NONE cterm=bold
hi Directory       guifg=#9fafaf gui=bold                     ctermfg=109 cterm=bold
hi ErrorMsg        guifg=#80d4aa guibg=#2f2f2f gui=bold       ctermfg=115 ctermbg=NONE cterm=bold
...
hi IncSearch       guifg=#f8f893 guibg=#385f38                ctermfg=228 ctermbg=NONE
...
hi PmenuSbar       guibg=#2e3330 guifg=#000000                ctermfg=16  ctermbg=NONE
hi PmenuThumb      guibg=#a0afa0 guifg=#040404                ctermfg=232 ctermbg=NONE
...
hi Search          guifg=#ffffe0 guibg=#284f28                ctermfg=230 ctermbg=NONE
...
hi StatusLine      guifg=#313633 guibg=#ccdc90                ctermfg=236 ctermbg=NONE
hi StatusLineNC    guifg=#2e3330 guibg=#88b090                ctermfg=235 ctermbg=NONE
...
hi VertSplit       guifg=#2e3330 guibg=#688060                ctermfg=236 ctermbg=NONE
hi VisualNOS       guifg=#333333 guibg=#f18c96 gui=bold,underline ctermfg=236 ctermbg=NONE cterm=bold
hi WarningMsg      guifg=#ffffff guibg=#333333 gui=bold       ctermfg=231 ctermbg=NONE cterm=bold
hi WildMenu        guifg=#cbecd0 guibg=#2c302d gui=underline  ctermfg=194 ctermbg=NONE cterm=underline

" spellchecking, always "bright" term background
hi SpellBad   guisp=#bc6c4c guifg=#dc8c6c  ctermfg=209 ctermbg=NONE
hi SpellCap   guisp=#6c6c9c guifg=#8c8cbc  ctermfg=103 ctermbg=NONE
hi SpellRare  guisp=#bc6c9c guifg=#bc8cbc  ctermfg=139 ctermbg=NONE
hi SpellLocal guisp=#7cac7c guifg=#9ccc9c  ctermfg=151 ctermbg=NONE
...
if exists("g:zenburn_old_Visual") && g:zenburn_old_Visual
    if exists("g:zenburn_alternate_Visual") && g:zenburn_alternate_Visual
        ...
        hi Visual          guifg=#000000 guibg=#71d3b4 gui=none  ctermfg=16  ctermbg=NONE  cterm=none
        hi VisualNOS       guifg=#000000 guibg=#71d3b4 gui=none  ctermfg=16  ctermbg=NONE  cterm=none
    else
        " use default visual
        hi Visual          guifg=#233323 guibg=#71d3b4 gui=none  ctermfg=235 ctermbg=NONE  cterm=none
        hi VisualNOS       guifg=#233323 guibg=#71d3b4 gui=none  ctermfg=235 ctermbg=NONE  cterm=none
    endif
else
    " new Visual style
    if exists("g:zenburn_alternate_Visual") && g:zenburn_alternate_Visual
        " brighter than the high/low contrast options below
        hi Visual        guibg=#304a3d  ctermbg=NONE
        hi VisualNos     guibg=#304a3d  ctermbg=NONE
    elseif exists("g:zenburn_high_Contrast") && g:zenburn_high_Contrast
        ...
        hi Visual        guibg=#0f0f0f  ctermbg=NONE
        hi VisualNOS     guibg=#0f0f0f  ctermbg=NONE
        if exists("g:zenburn_transparent") && g:zenburn_transparent
            hi Visual ctermbg=NONE
        endif
    else
        " low contrast
        hi Visual        guibg=#2f2f2f  ctermbg=NONE
        hi VisualNOS     guibg=#2f2f2f  ctermbg=NONE
    endif
endif

if exists("g:zenburn_alternate_Error") && g:zenburn_alternate_Error
    " use more jumpy Error
    hi Error    guifg=#e37170 guibg=#664040 gui=bold  ctermfg=210 ctermbg=NONE cterm=bold
else
    " default is something more zenburn-compatible
    hi Error    guifg=#e37170 guibg=#3d3535 gui=bold  ctermfg=167 ctermbg=NONE cterm=bold
endif
...
if version >= 800
    hi Terminal ctermbg=NONE guibg=#0f0f0f ctermfg=248 guifg=#a8a8a8
endif
